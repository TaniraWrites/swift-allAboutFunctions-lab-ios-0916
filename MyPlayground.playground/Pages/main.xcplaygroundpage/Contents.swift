...
var villain = "Harley Quinn"
favCharacter(villain)
...
favBand("Jimi Hendrix and the Experience", num: 1)
 ...
 */
    ...
    madLib("Manhattan", noun: "Flatiron School", preposition: "under")
 ...
 */
    func toyStorysequel(name:String) ->String{
        return "To infinity and beyond,\(name.uppercaseString)!"
}
    
toyStorysequel("Buzz Lightyear")
